...
@Schema(name = "AccountPaymentPageRequest", description = "Parâmetros de paginação e ordenação para consultas de pagamentos")
public record AccountPaymentPageRequest(
    ...
    public AccountPaymentPageRequest {
        if (page == null) page = 0;
